...
def main():
    ...
    # in the environment
    # Initialize wandb
    # wandb.init(project="GPT2", config=args)
    ...
    def tokenize_function(examples):
        # Tokenize the text
        tokenized_inputs = tokenizer(examples['text'], padding='max_length', max_length=12)
        ...
        tokenized_labels = tokenizer(examples['label'], padding='max_length', max_length=12)
    ...
    if args.tokenized_dataset:
        ...
        def proc_texts(examples):
            ...
            for input_ids, labels in zip(examples['input_ids'], examples['labels']):
                ...
                # label_shifted = concatenated_example.copy()
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        if args.checkpointing_steps == "epoch":
            ...
            if args.output_dir is not None:
                output_dir = os.path.join(args.output_dir, output_dir)
            accelerator.save_state(output_dir, safe_serialization=False)  # safe_serialization MUST be False, otherwise lm_head weight is dropped misteriously
